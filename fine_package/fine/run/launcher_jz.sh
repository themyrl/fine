#!/bin/bash
#SBATCH --job-name=glamv2_bcv_nta_f0     # job name
...
#SBATCH --output=logs/glamv2_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/glamv2_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
