...
#SBATCH --output=logs/at2w.out # output file name # add %j to id the job
#SBATCH --error=logs/at2w.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
