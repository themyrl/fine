#!/bin/bash
#SBATCH --job-name=at2wev     # job name
...
#SBATCH --output=logs/at2wev.out # output file name # add %j to id the job
#SBATCH --error=logs/at2wev.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
