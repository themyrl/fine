#!/bin/bash
#SBATCH --job-name=glv2un_livus_nta     # job name
...
#SBATCH --output=logs/glv2un_livus_nta.out # output file name # add %j to id the job
#SBATCH --error=logs/glv2un_livus_nta.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
