#!/bin/bash
#SBATCH --job-name=funv4_bcv_nta_f0     # job name
...
#SBATCH --output=logs/funv4_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/funv4_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
...
srun python fine_package/fine/run/run.py -network nnUNetTrainerV2_fineUNet_v4 -task 017 -outpath f0notta_FINEV4NNUNET -na #funv4_bcv_nta_f0
...
# srun python fine_package/fine/run/run.py -network nnUNetTrainerV2_finev3 -task 017 -outpath f0notta_FINEV32 -continu #-continu #finv32_bcv_nta ; finv32_bcv_nta_c ; finv32_bcv_nta_f0 ; finv32_bcv_nta_f0_c
# srun python fine_package/fine/run/run.py -network nnUNetTrainerV2_finev4 -task 017 -outpath f0notta_FINEV4 #-continu # finv4_bcv_nta_f0
