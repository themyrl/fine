#!/bin/bash
#SBATCH --job-name=debug_3     # job name
...
#SBATCH --output=logs/debug_3.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_3.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
