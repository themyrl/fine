#!/bin/bash
#SBATCH --job-name=at3wev     # job name
...
#SBATCH --output=logs/at3wev.out # output file name # add %j to id the job
#SBATCH --error=logs/at3wev.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
