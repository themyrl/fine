#!/bin/bash
#SBATCH -A arf@v100
#SBATCH --job-name=fbv1evb     # job name
...
#SBATCH --output=logs/fbv1evb.out # output file name # add %j to id the job
#SBATCH --error=logs/fbv1evb.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
