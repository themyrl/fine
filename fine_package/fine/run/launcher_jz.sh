#!/bin/bash
#SBATCH --job-name=nnf_bcv_nta_f0     # job name
...
#SBATCH --output=logs/nnf_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/nnf_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
