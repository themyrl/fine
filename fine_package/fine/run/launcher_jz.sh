#!/bin/bash
#SBATCH --job-name=nta_unet_word_128_eval     # job name
...
#SBATCH --output=logs/nta_unet_word_128_eval.out # output file name # add %j to id the job
#SBATCH --error=logs/nta_unet_word_128_eval.err  # error file name # add %j to id the job
# # SBATCH -C v100-32g
...
# srun python fine_package/fine/run/run.py nnUNetTrainerV2_fineUNet 140 notta_FINENNUNET 1 1 0 #nta_finun_word_eval
