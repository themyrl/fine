#!/bin/bash
#SBATCH --job-name=nnun_bcv_nta_f0     # job name
...
#SBATCH --output=logs/nnun_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/nnun_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
