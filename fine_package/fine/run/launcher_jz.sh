#!/bin/bash
#SBATCH --job-name=fi32u2_livus     # job name
...
#SBATCH --output=logs/fi32u2_livus.out # output file name # add %j to id the job
#SBATCH --error=logs/fi32u2_livus.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
