...
#SBATCH --output=logs/am6w.out # output file name # add %j to id the job
#SBATCH --error=logs/am6w.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
