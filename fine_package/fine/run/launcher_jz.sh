#!/bin/bash
#SBATCH --job-name=cofi_livus     # job name
...
#SBATCH --output=logs/cofi_livus.out # output file name # add %j to id the job
#SBATCH --error=logs/cofi_livus.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
