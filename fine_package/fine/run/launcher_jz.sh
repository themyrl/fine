#!/bin/bash
#SBATCH --job-name=debug_8     # job name
...
#SBATCH --output=logs/debug_8.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_8.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
