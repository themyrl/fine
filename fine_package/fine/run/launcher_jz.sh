#!/bin/bash
#SBATCH --job-name=funv3v2_livus     # job name
...
#SBATCH --output=logs/funv3v2_livus.out # output file name # add %j to id the job
#SBATCH --error=logs/funv3v2_livus.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
