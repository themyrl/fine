...
from fine.network_architecture.fine_UNet_v3 import Fine_UNet_v3
...
class nnUNetTrainerV2_fineUNet_v3(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Fine_UNet_v3(self.num_input_channels, self.base_num_features, self.num_classes,
