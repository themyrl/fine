#!/bin/bash
#SBATCH --job-name=unet_livus     # job name
...
#SBATCH --output=logs/unet_livus.out # output file name # add %j to id the job
#SBATCH --error=logs/unet_livus.err  # error file name # add %j to id the job
# # SBATCH -C v100-32g
