...
from fine.network_architecture.ResTranUnet_agno_fine_v2 import ResTranUnet
# from nnunet.network_architecture.generic_modular_UNet import get_default_network_config
# python run_training.py -network='2d' -network_trainer=nnUNetTrainerV2_fine_mhsa -task=062 -fold='all' -gpu=1 -outpath='MHSA'
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_CoTR_FINE_v2(nnUNetTrainer):
