#!/bin/bash
#SBATCH -A arf@v100
#SBATCH --job-name=fbv3c50l3     # job name
...
#SBATCH --output=logs/fbv3c50l3.out # output file name # add %j to id the job
#SBATCH --error=logs/fbv3c50l3.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
