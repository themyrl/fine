#!/bin/bash
#SBATCH --job-name=am4wev     # job name
...
#SBATCH --output=logs/am4wev.out # output file name # add %j to id the job
#SBATCH --error=logs/am4wev.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
