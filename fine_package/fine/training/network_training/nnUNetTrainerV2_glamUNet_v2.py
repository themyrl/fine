...
from fine.network_architecture.glam_UNet_v2 import Glam_UNet_v2
...
class nnUNetTrainerV2_glamUNet_v2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Glam_UNet_v2(self.num_input_channels, self.base_num_features, self.num_classes,
