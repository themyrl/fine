#!/bin/bash
#SBATCH --job-name=cofi_bcv_nta_f0     # job name
...
#SBATCH --output=logs/cofi_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/cofi_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
