#!/bin/bash
#SBATCH --job-name=finunv21_word     # job name
...
#SBATCH --output=logs/finunv21_word.out # output file name # add %j to id the job
#SBATCH --error=logs/finunv21_word.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
