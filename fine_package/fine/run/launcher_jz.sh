#!/bin/bash
#SBATCH --job-name=al2wev     # job name
...
#SBATCH --output=logs/al2wev.out # output file name # add %j to id the job
#SBATCH --error=logs/al2wev.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
