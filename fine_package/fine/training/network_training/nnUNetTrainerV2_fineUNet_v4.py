...
from fine.network_architecture.fine_UNet_v4 import Fine_UNet_v4
...
class nnUNetTrainerV2_fineUNet_v4(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Fine_UNet_v4(self.num_input_channels, self.base_num_features, self.num_classes,
