#!/bin/bash
#SBATCH --job-name=debug_4     # job name
...
#SBATCH --output=logs/debug_4.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_4.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
