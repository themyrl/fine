...
class nnUNetTrainerV2_dft(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_dft_2
    """
    ...
    def on_epoch_end(self):
        ...
        # it can rarely happen that the momentum of nnUNetTrainerV2_dft is too high for some dataset. If at epoch 100 the
