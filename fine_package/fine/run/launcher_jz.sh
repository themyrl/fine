#!/bin/bash
#SBATCH --job-name=glv2un_livus     # job name
...
#SBATCH --output=logs/glv2un_livus.out # output file name # add %j to id the job
#SBATCH --error=logs/glv2un_livus.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
