#!/bin/bash
#SBATCH --job-name=fi32u2_word     # job name
...
#SBATCH --output=logs/fi32u2_word.out # output file name # add %j to id the job
#SBATCH --error=logs/fi32u2_word.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
