#!/bin/bash
#SBATCH --job-name=funv3v2_livus_eval     # job name
...
#SBATCH --output=logs/funv3v2_livus_eval.out # output file name # add %j to id the job
#SBATCH --error=logs/funv3v2_livus_eval.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
