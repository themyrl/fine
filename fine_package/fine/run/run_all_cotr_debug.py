...
g = '0'
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_CoTR_debug', task='062', fold=1, outpath='dbgCOTR', val=False, npz=True)
run.main(gpu=g, network='3d_fullres', network_trainer='nnUNetTrainerV2_CoTR_debug', task='062', fold=1, outpath='dbgCOTR', val=True, npz=True)
