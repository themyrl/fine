#!/bin/bash
#SBATCH --job-name=debug_6     # job name
...
#SBATCH --output=logs/debug_6.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_6.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
