#!/bin/bash
#SBATCH --job-name=finv5_bcv_nta_f0     # job name
...
#SBATCH --output=logs/finv5_bcv_nta_f0.out # output file name # add %j to id the job
#SBATCH --error=logs/finv5_bcv_nta_f0.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
...
# srun python fine_package/fine/run/compute_assd.py -network notta_FINEV32NNUNETV2 -task 130 -n_classe 4
...
srun python fine_package/fine/run/run.py -network nnUNetTrainerV2_finev5 -task 017 -outpath f0notta_FINEV5 #-continu # finv5_bcv_nta_f0 ; finv5_bcv_nta_f0_c
