#!/bin/bash
#SBATCH --job-name=debug_7     # job name
...
#SBATCH --output=logs/debug_7.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_7.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
