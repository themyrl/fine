...
# srun python fine_package/fine/run/run.py nnUNetTrainerV2_nnFormer 140 NNFORMER 1 0 #nnfo_word_eval
srun python fine_package/fine/run/run.py nnUNetTrainerV2_fine 140 FINE 1 0 #fine_word_eval
