#!/bin/bash
#SBATCH --job-name=unet_word_dft     # job name
...
#SBATCH --output=logs/unet_word_dft.out # output file name # add %j to id the job
#SBATCH --error=logs/unet_word_dft.err  # error file name # add %j to id the job
# # SBATCH -C v100-32g
