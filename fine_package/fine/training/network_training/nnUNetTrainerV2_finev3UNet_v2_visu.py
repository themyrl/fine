...
from fine.network_architecture.finev3_UNet_v2_visu import Finev3_UNet_v2_visu
...
class nnUNetTrainerV2_finev3UNet_v2_visu(nnUNetTrainer):
    """
    Info for Fabian: same as internal nnUNetTrainerV2_fineUNet_2
    """
    ...
    def initialize_network(self):
        ...
        self.network = Finev3_UNet_v2_visu(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    vt_map=grid_size, max_imsize=max_sizes, clip=self.clip)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        ret = super().validate(do_mirroring=do_mirroring, use_sliding_window=use_sliding_window, step_size=1,
    ...
    def on_epoch_end(self):
        ...
        # it can rarely happen that the momentum of nnUNetTrainerV2_fineUNet is too high for some dataset. If at epoch 100 the
