#!/bin/bash
#SBATCH --job-name=finv32_word_c     # job name
...
#SBATCH --output=logs/finv32_word_c.out # output file name # add %j to id the job
#SBATCH --error=logs/finv32_word_c.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
