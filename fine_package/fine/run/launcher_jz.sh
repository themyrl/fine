#!/bin/bash
#SBATCH --job-name=cofi_bcv_nta_f0_dbg     # job name
...
#SBATCH --output=logs/cofi_bcv_nta_f0_dbg.out # output file name # add %j to id the job
#SBATCH --error=logs/cofi_bcv_nta_f0_dbg.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
...
# srun python fine_package/fine/run/run.py -network nnUNetTrainerV2_finev3 -task 017 -outpath f0notta_FINEV32 #-continu #finv32_bcv_nta ; finv32_bcv_nta_c ; finv32_bcv_nta_f0
