...
#SBATCH --output=logs/fbv2.out # output file name # add %j to id the job
#SBATCH --error=logs/fbv2.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
