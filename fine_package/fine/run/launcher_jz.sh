#!/bin/bash
#SBATCH --job-name=debug_5     # job name
...
#SBATCH --output=logs/debug_5.out # output file name # add %j to id the job
#SBATCH --error=logs/debug_5.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
