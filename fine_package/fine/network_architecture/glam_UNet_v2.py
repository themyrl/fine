...
import fine.network_architecture.glam as glam
...
class Glam_UNet_v2(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Glam_UNet_v2, self).__init__()
        ...
        for ii in range(len(self.input_sizes)):
            if self.do_fine[ii]:
                self.fine_module_list.append( glam.BasicLayer(
                        ...
                        downsample=None,
                        use_checkpoint=False, gt_num=1, id_layer=ii))
            else:
    ...
    def forward(self, x, pos=None):
        ...
        for d in range(len(self.conv_blocks_context) - 1):
            ...
            if self.do_fine[d]:
                ...
                x_out, S, H, W, x, Ws, Wh, Ww = self.fine_module_list[d](x, Ws, Wh, Ww)
