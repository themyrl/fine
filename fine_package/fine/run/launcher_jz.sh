#!/bin/bash
#SBATCH --job-name=fi32u2_livus_nta     # job name
...
#SBATCH --output=logs/fi32u2_livus_nta.out # output file name # add %j to id the job
#SBATCH --error=logs/fi32u2_livus_nta.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
