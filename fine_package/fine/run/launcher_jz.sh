#!/bin/bash
#SBATCH --job-name=glunv2_word_eval     # job name
...
#SBATCH --output=logs/glunv2_word_eval.out # output file name # add %j to id the job
#SBATCH --error=logs/glunv2_word_eval.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
