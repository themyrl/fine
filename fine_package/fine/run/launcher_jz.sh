#!/bin/bash
#SBATCH --job-name=am6wev     # job name
...
#SBATCH --output=logs/am6wev.out # output file name # add %j to id the job
#SBATCH --error=logs/am6wev.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
