#!/bin/bash
#SBATCH --job-name=nta_unet_word_eval     # job name
...
#SBATCH --output=logs/nta_unet_word_eval.out # output file name # add %j to id the job
#SBATCH --error=logs/nta_unet_word_eval.err  # error file name # add %j to id the job
# # SBATCH -C v100-32g
