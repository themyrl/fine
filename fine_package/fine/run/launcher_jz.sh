...
#SBATCH --output=logs/at4w.out # output file name # add %j to id the job
#SBATCH --error=logs/at4w.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
