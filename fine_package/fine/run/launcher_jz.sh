...
#SBATCH --output=logs/al3w.out # output file name # add %j to id the job
#SBATCH --error=logs/al3w.err  # error file name # add %j to id the job
#SBATCH -C v100-32g
