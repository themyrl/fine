#!/bin/bash
#SBATCH --job-name=fine_word_c     # job name
...
#SBATCH --output=logs/fine_word_c.out # output file name # add %j to id the job
#SBATCH --error=logs/fine_word_c.err  # error file name # add %j to id the job
# # SBATCH -C v100-32g
...
# srun python fine_package/fine/run/run_all_nnformer.py #nnformer_livsus & nnfo_word+_eval
